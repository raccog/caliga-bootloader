...
qemu-system-aarch64 -machine virt -cpu cortex-a57 -device loader,file=target/aarch64-unknown-none/debug/caliga-qemu-aarch64,addr=0x40100000,cpu-num=0 -S -serial stdio
